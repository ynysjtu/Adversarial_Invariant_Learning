...
class PSST_LSTM(nn.Module):
    def __init__(self, hidden_size=200, lstm_layers=2, dropout=0.3, seq_length=10, n_classes=2):
        super().__init__()
        self.seq_len = seq_length
        self.lstm_layers = lstm_layers
        self.hidden_size = hidden_size
        self.lstm = nn.LSTM(input_size=50,hidden_size=hidden_size,num_layers=lstm_layers,batch_first=True,dropout=dropout)
        # self.output_layer = nn.Linear(hidden_size, n_classes)
        self.n_outputs = hidden_size
